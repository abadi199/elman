...
var _zabadi199$elman$Model$height = function (world) {
	return _eeue56$elm_flat_matrix$Matrix$height(world.level) * _zabadi199$elman$Model$tileSize(world);
};
var _zabadi199$elman$Model$width = function (world) {
	return _eeue56$elm_flat_matrix$Matrix$width(world.level) * _zabadi199$elman$Model$tileSize(world);
};
var _zabadi199$elman$Model$Model = F2(
	function (a, b) {
		return {world: a, hero: b};
	});
var _zabadi199$elman$Model$World = F2(
	function (a, b) {
		return {tileSize: a, level: b};
	});
var _zabadi199$elman$Model$Hero = F4(
	function (a, b, c, d) {
		return {move: a, direction: b, position: c, speed: d};
	});
var _zabadi199$elman$Model$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
...
var _zabadi199$elman$Model$TileSize = function (a) {
	return {ctor: 'TileSize', _0: a};
};
var _zabadi199$elman$Model$world = F2(
	function (tileSize, level) {
		return {
			tileSize: _zabadi199$elman$Model$TileSize(tileSize),
			level: level
		};
	});
var _zabadi199$elman$Model$Right = {ctor: 'Right'};
...
var _zabadi199$elman$View_Pacman$pacman = F3(
	function (time, world, hero) {
		var translate = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(hero.position.x),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(hero.position.y),
						')'))));
		var rotation = function () {
			var _p0 = hero.direction;
			switch (_p0.ctor) {
				case 'Up':
					return -90;
				case 'Down':
		...
		var startY = _elm_lang$core$Basics$toString(
			radius - _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(radius) * _elm_lang$core$Basics$sin(mouthAngle)));
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$fill('#ffcc00'),
				_1: {
					ctor: '::',
...
var _zabadi199$elman$View$level = function (world) {
	...
	var toCoordinate = function (_p0) {
		...
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: _p1._0._0 * tileSize, _1: _p1._0._1 * tileSize},
			_1: _p1._1
		};
	};
	var tiles = _elm_lang$core$Array$toList(
		A2(
			...
			A2(
				_elm_lang$core$Array$map,
				toCoordinate,
				_eeue56$elm_flat_matrix$Matrix$toIndexedArray(world.level))));
	return A2(
		_elm_lang$svg$Svg$g,
		{ctor: '[]'},
		tiles);
};
var _zabadi199$elman$View$view = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3._1;
	var background = A2(
		...
		{ctor: '[]'});
	var viewPort = _elm_lang$svg$Svg$svg(
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width('100%'),
			_1: {
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toString(
									_zabadi199$elman$Model$width(_p4.world)),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ',
									_elm_lang$core$Basics$toString(
										_zabadi199$elman$Model$height(_p4.world)))))),
					_1: {ctor: '[]'}
				}
			}
		});
	var container = _elm_lang$html$Html$div(
		{
			ctor: '::',
...
var _zabadi199$elman$Update$changeDirection = F3(
	function (keyCode, time, model) {
		var hero = model.hero;
		var _p0 = _elm_lang$core$Native_Utils.eq(keyCode, _zabadi199$elman$KeyCode$left) ? {ctor: '_Tuple2', _0: _zabadi199$elman$Model$Left, _1: true} : (_elm_lang$core$Native_Utils.eq(keyCode, _zabadi199$elman$KeyCode$right) ? {ctor: '_Tuple2', _0: _zabadi199$elman$Model$Right, _1: true} : (_elm_lang$core$Native_Utils.eq(keyCode, _zabadi199$elman$KeyCode$up) ? {ctor: '_Tuple2', _0: _zabadi199$elman$Model$Up, _1: true} : (_elm_lang$core$Native_Utils.eq(keyCode, _zabadi199$elman$KeyCode$down) ? {ctor: '_Tuple2', _0: _zabadi199$elman$Model$Down, _1: true} : {ctor: '_Tuple2', _0: model.hero.direction, _1: model.hero.move})));
		var updatedDirection = _p0._0;
		var updatedMove = _p0._1;
		var updatedModel = _elm_lang$core$Native_Utils.update(
			model,
			{
				hero: _elm_lang$core$Native_Utils.update(
					hero,
					{direction: updatedDirection, move: updatedMove})
			});
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: time, _1: updatedModel},
...
var _zabadi199$elman$Update$moveHero = F3(
	function (time, world, hero) {
		var updatedHero = function () {
			if (!hero.move) {
				return hero;
			} else {
				var _p1 = hero.direction;
				switch (_p1.ctor) {
					case 'Up':
						return _elm_lang$core$Native_Utils.update(
							hero,
							{
								position: {x: hero.position.x, y: hero.position.y - hero.speed}
							});
					case 'Down':
						return _elm_lang$core$Native_Utils.update(
							hero,
					...
					case 'Left':
						return _elm_lang$core$Native_Utils.update(
							hero,
							{
								position: {x: hero.position.x - hero.speed, y: hero.position.y}
							});
					default:
						return _elm_lang$core$Native_Utils.update(
							hero,
		...
		return A2(_zabadi199$elman$Update$checkBoundaries, world, updatedHero);
	});
var _zabadi199$elman$Update$updateTime = F2(
	function (time, model) {
		var updatedModel = _elm_lang$core$Native_Utils.update(
			model,
			{
				hero: A3(_zabadi199$elman$Update$moveHero, time, model.world, model.hero)
			});
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: time, _1: updatedModel},
...
var _zabadi199$elman$Update$update = F2(
	function (msg, _p2) {
		var _p3 = _p2;
		var _p5 = _p3._1;
		var _p4 = msg;
		if (_p4.ctor === 'TimeUpdated') {
			return A2(_zabadi199$elman$Update$updateTime, _p4._0, _p5);
		} else {
...
var _zabadi199$elman$Main$subscriptions = function (_p0) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$times(_zabadi199$elman$Msg$TimeUpdated),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_zabadi199$elman$Msg$KeyPressed),
				_1: {ctor: '[]'}
			}
		});
};
var _zabadi199$elman$Main$init = {
	ctor: '_Tuple2',
	_0: {
		ctor: '_Tuple2',
		_0: 0,
...
if (typeof _zabadi199$elman$Main$main !== 'undefined') {
    _zabadi199$elman$Main$main(Elm['Main'], 'Main', undefined);
}
